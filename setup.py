...
def get_project_version():
    version_path = os.path.join(base_dir, "startgpt_whisper", "version.py")
    version = {}
...
setup(
    name="startgpt-whisper",
    version=get_project_version(),
    license="MIT",
    description="StartGPT Whisper transcription with CTranslate2",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    author="KhulnaSoft Lab",
    url="https://github.com/khulnasoft-lab/startgpt-whisper",
    classifiers=[
